  ...
  const handleSavePanel = () => {
    if (userProfile) {
      setUserProfile({
        ...
        specialty: isPsychologist ? specialty : userProfile.specialty,
        bio: isPsychologist ? bio : userProfile.bio,
      });
    }
    setActivePanel(null);
  ...
  return (
    <View style={styles.root}>
      ...
      <Modal visible={activePanel === 'datos'} animationType="slide">
        <SafeAreaView style={styles.panelRoot}>
          ...
          <ScrollView contentContainerStyle={styles.panelBody}>
            ...
            <Text style={styles.inputLabel}>Enlace de Foto de Perfil (URL)</Text>
            <TextInput style={styles.panelInput} value={photoURL} onChangeText={setPhotoURL} placeholder="https://..." placeholderTextColor={Colors.textDisabled} />
          ...
          <ScrollView contentContainerStyle={styles.panelBody}>
            <View style={styles.switchRow}>
              <View style={styles.switchInfo}>
                ...
                <Text style={styles.switchDesc}>Recibir alertas de nuevos mensajes</Text>
              </View>
            ...
            <View style={styles.switchRow}>
              <View style={styles.switchInfo}>
                <Text style={styles.switchTitle}>Nuevas ofertas / solicitudes</Text>
                <Text style={styles.switchDesc}>Alertar cuando haya peticiones de pacientes cerca</Text>
              </View>
      ...
      <CustomAlert
        ...
        message="Los datos del perfil han sido actualizados correctamente."
        confirmText="Aceptar"
