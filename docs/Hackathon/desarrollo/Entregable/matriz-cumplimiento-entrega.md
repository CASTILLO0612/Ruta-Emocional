...
| 8 | DER conceptual | [PDF final](Diagrama%20ER.pdf), [trazabilidad de 58 modelos](trazabilidad-modelo-vigente.md) | Usa notación de Chen, conserva ISA y N:N, y excluye tablas, FK, tipos SQL, índices y detalles físicos. | Cumple |
